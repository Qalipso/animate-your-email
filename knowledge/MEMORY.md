...
- [DEC-004: clipboard gate results](decisions/DEC-004-clipboard-gate-results.md) — Chrome+Gmail Strategy 1 CONFIRMED: Gmail keeps our external img URL as-is, does not re-host it; Strategy 2 inconclusive (clipboard race with concurrent user use); Outlook + Safari + Strategy 3 not yet run
